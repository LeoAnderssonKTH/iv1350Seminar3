...
public class SaleTest {
    ...
    public void testRegisterItem() {
        ...
        String actualName1 = sale.itemList[0].name;
        int expectedVAT1 = 3;
        int actualVAT1 = sale.itemList[0].VAT;
        int expectedQuantity1 = 3;
        int actualQuantity1 = sale.itemList[0].quantity;
        int expectedTotalCost1 = 9;
        int actualTotalCost1 = sale.itemList[0].totalCost;
        
        String expectedName2 = "Mjölk";
        String actualName2 = sale.itemList[1].name;
        int expectedVAT2 = 5;
        int actualVAT2 = sale.itemList[1].VAT;
        int expectedQuantity2 = 2;
        int actualQuantity2 = sale.itemList[1].quantity;
        int expectedTotalCost2 = 25;
        int actualTotalCost2 = sale.itemList[1].totalCost;
        
        int expectedTotalPriceOfSale = 77;
        int actualTotalPriceOfSale = sale.totalPrice;
        int expectedTotalVAT = 19;
        int actualTotalVAT = sale.totalVAT;
